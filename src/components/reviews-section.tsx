...
const ReviewsSection = () => {
  ...
  return (
    <div 
      className="w-full pt-4 pb-4 px-6"
      style={{ 
    ...
    >
      ...
      >
        ...
        <div className="mb-12 p-6 rounded-3xl max-w-md mx-auto" style={{ backgroundColor: '#E8E6DC' }}>
          ...
          <div className="space-y-3 w-full">
            {[
              ...
              "Understanding exactly what's happening to your body"
            ].map((item, i) => (
        ...
        >
          Discover how <span className="italic">The First Bump</span> is helping mothers—one page at a time.
        </p>
