...
const JourneySection = () => {
  return (
    <div 
      ...
      style={{ 
        background: 'linear-gradient(180deg, #ede8df 0%, #f5f3ed 100%)',
    ...
    >
      <div className="max-w-md mx-auto space-y-6">
        ...
        >
          ...
          <Button 
            className="font-normal px-8 py-6 rounded-full text-base shadow-lg transition-all duration-300 hover:scale-105"
            style={{ 
